...
public class FloatingGameEntityRealist : GameEntity
{
    ...
    protected override void Awake()
    {
        ...
        foreach (var a in m.vertices)
        {
            newVerticies.Add(new Vector3(a.x * transform.localScale.x, a.y * transform.localScale.y, a.z * transform.localScale.z));
        }
        ...
        WaterCutter.CookCache(newMesh, ref _triangles, ref worldBuffer, ref wetTris, ref dryTris);
    }
